...
function Whatweb() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // const resultText = await response;
      // const regex = ansiRegex();
      // const cleanText = stripAnsi(resultText.replace(regex, ""));
      // const regexx = /]/g;
      // const newString = cleanText.replace(regexx, "]\n");
      setIsLoading(false);
      setResult({
        input: inputText,
        tool: "sqlmap",
  ...
  return (
    ...
    >
      ...
      {!result && <h2 className="text-2xl font-bold text-light">Whatweb</h2>}
      <br />
      {!result && (
        <form
