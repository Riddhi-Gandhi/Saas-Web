  ...
  return (
    <div className={`bg-dark min-h-screen flex flex-col items-center justify-center`} style={{ backgroundImage: 'linear-gradient( #13042c, #240454, #240454,#3c2484,#4b2ea1,#3c2484,#240454,#13042c,#13042c)' }}>
      <div className="md:w-full text-light">
        <br /><br /><br /><br />
        <h2 className="para3">Mobile App Testing</h2><br></br>
      ...
      <div className="md:w-full mt-6 flex justify-center">
        {cardList.map((card, index) => (
          <div
            key={card.link}
            className={`group cursor-pointer h-80 w-112 md:h-96 md:w-112 mx-20 relative`}
            onClick={() => handleCardClick(card)}
            style={{ boxShadow: index === 0 ? '15px 30px 5px #3c2484' : '15px 15px 5px #3c2484' }}
          >
            <div className={`rounded-xl overflow-hidden bg-dark flex`}>
              <img
